/*!
 * modernizr v3.11.0
 * Build https://modernizr.com/download?-adownload-ambientlight-apng-applicationcache-arrow-atobbtoa-audio-audioautoplay-audioloop-audiopreload-avif-batteryapi-bdi-beacon-blobconstructor-bloburls-blobworkers-canvas-canvasblending-canvastext-canvaswinding-capture-classlist-clipboard-connectioneffectivetype-contenteditable-contextmenu-cookies-cors-createelementattrs_createelement_attrs-cryptography-customelements-customevent-customprotocolhandler-datachannel-dataset-datauri-dataview-dataworkers-details-devicemotion_deviceorientation-directory-documentfragment-emoji-es5-es5array-es5date-es5function-es5object-es5string-es5syntax-es5undefined-es6array-es6class-es6collections-es6math-es6number-es6object-es6string-es6symbol-es7array-es8object-eventlistener-eventsource-exiforientation-fetch-fileinput-filereader-filesystem-flash-forcetouch-formattribute-formvalidation-framed-fullscreen-gamepads-generators-geolocation-getrandomvalues-getusermedia-hashchange-hidden-hiddenscroll-history-hovermq-htmlimports-ie8compat-imgcrossorigin-indexeddb-indexeddb2-indexeddbblob-inlinesvg-input-inputformaction-inputformenctype-inputformmethod-inputformnovalidate-inputformtarget-inputsearchevent-inputtypes-intersectionobserver-intl-jpeg2000-jpegxr-json-lazyloading-ligatures-localizednumber-localstorage-lowbandwidth-lowbattery-matchmedia-mathml-mediasource-messagechannel-microdata-mutationobserver-notification-olreversed-oninput-outputelem-pagevisibility-passiveeventlisteners-peerconnection-performance-picture-placeholder-pointerevents-pointerlock-pointermq-postmessage-prefetch-progressbar_meter-promises-proximity-proxy-publickeycredential-queryselector-quotamanagement-requestanimationframe-requestautocomplete-resizeobserver-restdestructuringarray_restdestructuringobject-restparameters-ruby-sandbox-scriptasync-scriptdefer-scrolltooptions-seamless-serviceworker-sessionstorage-shadowroot-shadowrootlegacy-sharedworkers-sizes-smil-speechrecognition-speechsynthesis-spreadarray-spreadobject-srcdoc-srcset-strictmode-stringtemplate-stylescoped-svg-svgasimg-svgclippaths-svgfilters-svgforeignobject-template-textareamaxlength-textencoder_textdecoder-texttrackapi_track-time-todataurljpeg_todataurlpng_todataurlwebp-transferables-typedarrays-unicoderange-unknownelements-urlparser-urlsearchparams-userdata-vibrate-video-videoautoplay-videocrossorigin-videoloop-videopreload-vml-webanimations-webaudio-webgl-webglextensions-webintents-webp-webpalpha-webpanimation-webplossless_webp_lossless-websockets-websocketsbinary-websqldatabase-webworkers-xdomainrequest-xhr2-xhrresponsetype-xhrresponsetypearraybuffer-xhrresponsetypeblob-xhrresponsetypedocument-xhrresponsetypejson-xhrresponsetypetext-addtest-atrule-domprefixes-hasevent-load-mq-prefixed-prefixedcss-prefixes-printshiv-setclasses-testallprops-testprop-teststyles-dontmin
 *
 * Copyright (c)
 *  Faruk Ates
 *  Paul Irish
